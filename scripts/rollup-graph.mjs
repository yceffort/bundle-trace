...
import {importSites, sha256, sourcePath} from './graph-utils.mjs'

// Compatible with Rollup and Vite (including the Rolldown-backed Vite build).
export default function bundleTraceGraph({fileName = 'bundle-trace.graph.json', root = process.cwd()} = {}) {
  const inputs = new Map()
  let bundler = 'rollup'
  return {
    name: 'bundle-trace-graph', enforce: 'pre',
